    ...
    return (
        <div
            ...
            <header className="mt-8 mb-4 lg:mt-0 lg:mb-0 lg:sticky lg:top-4 lg:self-start">
                ...
                <p className="">I turn business ideas into custom software
                    solutions.</p>
                <ul className="my-8 space-y-1">
                    <li className="flex gap-2 items-center">
                        ...
                        <a href="mailto:martin.bednar33@gmail.com" className="text-blue-600 hover:underline">
                        <span>
                            martin.bednar33@gmail.com
                        </span>
                        </a></li>
                    <li className="flex gap-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <a href="https://www.linkedin.com/in/martin-bedn%C3%A1%C5%99-8275ab191/"
                    ...
                    <li className="flex gap-2 items-center">
                        ...
                        <a href="https://www.instagram.com/martin_b3dnar/" className="text-blue-600 hover:underline">
                            @martin_b3dnar
                        </a>
                    </li>
                    <li className="flex gap-2 items-center">
                        ...
                        <a href="https://github.com/martin-bednar" className="text-blue-600 hover:underline">
                            martin-bednar
                        </a>
                    </li>
                </ul>
            ...
            <main className="">
                <p className="my-4 text-justify">I&#39;m a full-stack software engineer focused on building custom
                    software and web applications that
                    solve
                ...
                <div className="my-4">
                    ...
                    <li><a href="https://sportera.cz/" className="text-blue-600 hover:underline">Sportera</a>, a
                            platform that maps public sports facilities,
                        </li>
                        <li><a href="https://decathlon.cz/" className="text-blue-600 hover:underline">decathlon.cz</a>,
                            an e-commerce platform for sports
                            equipment,
                        </li>
                        <li>and an internal platform dedicated to business process optimization at <a
                            href="https://www.decathlon.cz/SDblog_lp-7UOV4P" className="text-blue-600 hover:underline">Decathlon
                            CZ - Sustainability</a>.
                        </li>
                    </ul>
                </div>
                ...
                <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Developed a text-processing middleware to for generating the <a
                        href="https://en.wikipedia.org/wiki/Vocative_case" className="text-blue-600 hover:underline">vocative
                        case</a> of Czech names. The
                        middleware is
                ...
                <ul className="space-y-4">
                    <li><strong className="font-medium">Bachelor&#39;s Degree in Software Engineering</strong><br/>Czech
                        Technical University in
                        Prague, Faculty of Information Technology (2019 - 2022)
                    </li>
                    <li><strong className="font-medium">Erasmus Exchange Program</strong><br/>École Centrale de Nantes,
                        Control and Robotics
                        department (2023 - 2024)
                    </li>
                    <li><strong className="font-medium">Master&#39;s Degree in Software Engineering</strong><br/> Czech
                        Technical University in
                ...
                <ul className="">
                    <li><strong className="font-medium">Remote Function Calls for Haskell Applications
                        (2022).</strong> Bachelor&#39;s Thesis, Czech Technical
                        University in Prague. <a href="https://dspace.cvut.cz/handle/10467/102069"
                                                 className="text-blue-600 hover:underline">Published online</a></li>
                </ul>
